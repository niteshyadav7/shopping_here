      ...
      <nav class="bg-white border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800">
        <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
          <div class="flex items-center">
            <img src={img} class="cursor-pointer mr-3 h-6 sm:h-9" alt="Logo" />
            <span class="self-center text-red-900 whitespace-nowrap dark:text-white hover:text-red-700 hover:font-bold cursor-pointer font-bold text-2xl">
              N-Mart
            </span>
          </div>
